...
class ShowImage(QMainWindow):
    def __init__(self):
        ...
        ui_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'A11.ui')
        loadUi(ui_path, self) 
        ...
        self.actionHistogram_Equalization.triggered.connect(self.histEqualization) # KABEL BARU A11
